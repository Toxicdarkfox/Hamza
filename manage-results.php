                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT  distinct tblstudents.StudentName,tblstudents.RoolId,tblstudents.Dob,tblstudents.StudentEmail,tblstudents.Status,tblclasses.ClassName,tblclasses.ClassNameNumeric,tblclasses.Section from tblresult join tblstudents on tblstudents.StudentName=tblresult.Studentname  join tblclasses on tblclasses.Classname=tblresult.ClassId";
