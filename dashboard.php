...
<?php
$sql1 ="SELECT Roolid from tblstudents ";
...
<?php
$sql ="SELECT SubjectName from  tblsubjects ";
...
?>
                                            ...
                                            <span class="name">Subjects List</span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        ...
                                        <?php
$sql2 ="SELECT ClassName from  tblclasses ";
...
?>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        ...
                                        <?php
$sql3="SELECT  distinct StudentName from  tblresult ";
